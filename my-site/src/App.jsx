...
const WALKS = [
  ...
  { id: "st-mawes", name: "St Mawes Castle Walk", desc: "A circular walk around this section of the Roseland peninsula. Enjoy views of St Mawes castle and the stunning Fal estuary, a woodland trail (collect wild garlic in spring) and back through Polvarth boatyard. Reward yourself with a coffee, cruffin and saffron bun at the harbour bakery in St Mawes. ⚠️🚧 The path has eroded as you approach the boatyard and is not currently suitable for less able walkers.", length: "4 miles", parking: "St Mawes main car park (pay and display). Free in winter months.", image: imgStMawesCastle, stravaRouteId: "3527708808757151026" },
