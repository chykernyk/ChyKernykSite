...
const WALKS = [
  ...
  { id: "st-mawes", name: "St Mawes Castle Walk", desc: "Grab a coffee, cruffin and saffron bun at the harbour bakery in St Mawes and set off for a circular walk around the peninsula. Enjoy views of St Mawes castle and the stunning Fal estuary, a woodland trail (collect wild garlic in spring) and back through Polvarth boatyard.", length: "4 miles", parking: "St Mawes main car park (pay and display). Free in winter months.", image: imgStMawesCastle, stravaRouteId: "3508117047959651292" },
