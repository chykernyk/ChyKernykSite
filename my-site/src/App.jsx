...
const ACTIVITIES = [
  ...
  { id: "harbour-wall-jumping-portscatho", name: "Harbour Wall Jumping (Portscatho)", desc: "Harbour wall jumping is a rite of passage for all children. Portscatho offers a gentler introduction for newcomers and better viewing for parents. This is a high tide only activity!", tags: ["harbour", "jumping", "family"], category: "beach" },
...
const WALKS = [
  ...
  { id: "st-anthony-light", name: "St Anthony Short", desc: "You can drive to St Anthony where there is some parking, then walk anti-clockwise along the coastal path to Bohortha, then over the hill to Place. Stop to look at St Anthony Church, sign the visitors book (it helps support the church) then over the hill again to look across at St Mawes, Falmouth and finish with the lighthouse, the home of the Fraggles of Fraggle Rock (Davina's favourite program as a child).", length: "3.6 miles", difficulty: "Easy-Moderate", parking: "Small car park at St Anthony — limited spaces, arrive early in summer.", eating: "The Place restaurant (seasonal), or continue on to St Mawes for the Tresanton or the pub on the quay.", image: imgStAnthonyLight, stravaRouteId: "3512380107759473190" },
