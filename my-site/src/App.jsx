...
const ACTIVITIES = [
  { id: "st-just-in-roseland", name: "St Just in Roseland Church", desc: "One of the most beautiful churchyards in England, with subtropical planting tumbling down to the edge of a tidal creek. A peaceful spot, and a favourite of poet John Betjeman - \"to many people the most beautiful churchyard on earth\".", tags: ["church", "gardens", "creek"], image: imgStJustInRoseland },
