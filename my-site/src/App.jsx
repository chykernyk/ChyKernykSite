...
const ACTIVITIES = [
  ...
  { id: "lamorran", name: "Lamorran House Garden", desc: "An intimate four-acre subtropical garden on a south-facing hillside above St Mawes, with sea views out to St Anthony Head. Home to one of the most northerly palm collections in the world — over 200 specimens across 35 species — plus an extensive collection of tree ferns. Open Wednesdays and Fridays, April to September.", tags: ["gardens", "subtropical", "palms"], category: "garden", website: "https://www.lamorrangardens.co.uk/" },
