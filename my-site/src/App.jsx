...
import imgHouseConstruction from "./assets/images/HouseConstruction.jpg";
...
import imgThirsteaCo from "./assets/images/ThirsteaCo.jpeg";
import imgTowanShellPicking from "./assets/images/TowanShellPicking.jpeg";
import imgTrebah from "./assets/images/Trebah.jpeg";
...
const HERO_IMAGES = [
  ...
  { url: imgHouseConstruction, caption: "The House" },
...
const ACTIVITIES = [
  ...
  { id: "heligan", name: "The Lost Gardens of Heligan", desc: "An amazing, rediscovered garden that was brought back from the brink in the 80s & 90s. Explore the jungle, brave the rope bridge, check out the walled gardens, and the famous sleeping mud maid.", image: imgHeligan, tags: ["gardens", "history"], category: "garden", website: "https://www.heligan.com/" },
  { id: "eden-project", name: "Eden Project", desc: "The iconic biomes housing the world's largest indoor rainforest. A must-visit that never disappoints, whatever the weather.", image: imgEdenProject, tags: ["attraction", "family"], category: "garden", website: "https://www.edenproject.com/visit?gad_source=1&gad_campaignid=23817630885&gclid=CjwKCAjwvNfSBhBiEiwAyaGMCSqznnvse6YxgbKKXqLt9H6dXCAbtEeSeiXH7ascowP9Lj8A8_Lj4BoCjxcQAvD_BwE" },
  ...
  { id: "porthcurnick", name: "Porthcurnick", desc: "Our local dog friendly beach owned by the National Trust. Cross over the road then follow the path left down from the car park. Good for a long swim back to Portscatho at high tide or a scramble around the rock pools at low tide. It is served by the famous Hidden Hut with great food, drinks and ice cream.", image: imgPorthcurnick, tags: ["beach", "walking", "family"], category: "beach", eating: "Hidden Hut", eatingUrl: "https://hiddenhut.co.uk/", eatingImage: imgHiddenHut, address: ["Porthcurnick Beach", "Portscatho", "The Roseland", "Cornwall", "TR2 5EW"] },
  { id: "towan", name: "Towan Beach", desc: "A National Trust beach, better reached by a walk from Portscatho which takes about ¾ of an hour. Limited parking is available at the National Trust car park at Porth Farm, TR2 5EX. Nice swimming, traditionally the top beach for shell hunting — there is the Thirstea café across the road from the car park. Dog friendly beach.", image: imgTowanShellPicking, tags: ["beach", "rockpools", "family"], category: "beach", eating: "Thirstea Co", eatingUrl: "https://thethirsteacompany.co.uk/", eatingImage: imgThirsteaCo },
  { id: "pendower", name: "Pendower Beach", desc: "A mile long, gently shelving sandy beach next to Carne. Great starting point for the Nare's Head walk or just a day building sandcastles. Excellent Shallikabooky café at the Pendower. Dog friendly beach, short lead required during summer months.", image: imgCarneBeach, tags: ["beach", "walking", "family"], category: "beach", eating: "Shallikabooky", eatingUrl: "https://m.facebook.com/shallikabooky/", eatingImage: imgShillakabookyBeachHut },
...
const WALKS = [
  ...
  { id: "st-just-in-roseland", name: "St Just in Roseland", desc: "Starting from the magical waterside churchyard at St Just in Roseland (Betjeman's \"most beautiful churchyard on earth\") surrounded by palm trees, explore the peninsula's winding wooded creeks, farmland and coast paths. From Messack Point, your reward for the climb will be far-reaching views across the Carrick Roads, including Pendennis Castle, Falmouth, Mylor and Restronguet. Visit Renwicks Cafe for a cooked breakfast or cream tea at the end.", length: "3.7 miles", parking: "St Just in Roseland church car park, TR2 5JD.", eating: "Renwicks Cafe", eatingUrl: "https://www.falriver.co.uk/eat-and-drink/renwicks-cafe", eatingImage: imgRenwicks, eatingNote: "Renwicks Cafe is open 7 days per week for breakfast, lunch and Cornish cream teas. The shop sells a selection of local art, gifts and homeware. Dog friendly.", furtherInfoUrl: "https://www.nationaltrust.org.uk/visit/cornwall/porth/roseland-messack-creek-and-woodland-walk", image: imgStJustInRoseland, stravaRouteId: "3524484298006413682" },
  { id: "nare", name: "Nare Head", desc: "Drive to Pendower Beach for a spectacular circular walk around Nare Head with panoramic views of Gull Rock and the coast. This walk is rated 'difficult' with some steep sections. Reward yourself with coffee and ice cream at the Shallikabooky Beach Hut at the end.", length: "4 miles", parking: "Park at Carne Beach car park (free for National Trust members). Can get busy in summer — arrive before 10am.", eating: "The Shallikabooky Beach Hut is a perfect post-walk stop for something simple and delicious right by the water.", image: imgNareHead, stravaRouteId: "3507453955926855126" },
  { id: "st-mawes", name: "St Mawes Castle Walk", desc: "A circular walk around this section of the Roseland peninsula. Enjoy views of St Mawes castle and the stunning Fal estuary, a woodland trail (collect wild garlic in spring) and back through Polvarth boatyard. Reward yourself with a coffee, cruffin and saffron bun at the harbour bakery in St Mawes.\n⚠️🚧 The path has eroded as you approach the boatyard and is not currently suitable for less able walkers.", length: "4 miles", parking: "Park in the Castle car park.", image: imgStMawesCastle, stravaRouteId: "3527708808757151026" },
  { id: "towan", name: "Towan Beach Circuit", desc: "A circular walk south from Portscatho along National Trust coastline and back through pretty farmland and quiet country roads. Spot Towan's resident seals, go cowrie shell hunting on the beach, and enjoy delicious toasties and refreshments at the Thirstea Co beach cafe. A great circuit for runners. Dog friendly beach.", length: "4.3 miles", parking: "Limited parking is available at the National Trust car park at Porth Farm, TR2 5EX.", eating: "Thirstea Co", eatingUrl: "https://thethirsteacompany.co.uk/", eatingImage: imgThirsteaCo, image: imgTowanShellPicking, stravaRouteId: "3508117195142270626" },
  ...
  { id: "st-anthony", name: "St Anthony Head (long route)", desc: "A more ambitious walk from Portscatho all the way to St Anthony's lighthouse at the tip of the Roseland Peninsula, passing pretty local farmland and coastal views along the way. Take a picnic for the half way point.", length: "10 miles", parking: "National Trust car park at Place. Follow signs carefully — the lanes are narrow.", image: imgStAnthony, stravaRouteId: "3508119257673450600" },
];

const PARKRUNS = [
  { name: "Trelissick", url: "https://www.parkrun.org.uk/trelissick/", desc: "A beautiful course from the National Trust grounds at Trelissick along the estuary. Deceptively gentle slope followed by once around a field and back. Would be fine, but watch out for that field." },
  { name: "Penryn Campus", url: "https://www.parkrun.org.uk/penryncampus/", desc: "A tarmac course around Falmouth University's Penryn Campus. Like so many of the Cornish parkruns there are hills involved, this time three laps up and down the side of Packsaddle Hill." },
  ...
  { name: "Lanhydrock", url: "https://www.parkrun.org.uk/lanhydrock/", desc: "Set in the stunning grounds of Lanhydrock House. A single-lap course through parkland and woodland. You start at the top of a hill and run downhill for the next 3½kms. The problem is that you ran past the finish after about 200m and you know you have to get back over the hill!!" },
];
...
const CSS = `
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .ck-detail-body p { margin-bottom:1.5rem; white-space:pre-line; }
  .ck-ferry-status {
  ...
  return (
    <>
      ...
      <div className="ck-detail-content">
        ...
        {activity.eating && activity.eatingUrl && activity.eatingImage && (
          <div className="ck-detail-info">
            <h3>Nearby Café</h3>
            <a href={activity.eatingUrl} target="_blank" rel="noopener noreferrer" className="ck-walk-eat-chip">
          ...
          <div className="ck-detail-info">
            ...
            {walk.eatingUrl && walk.eatingImage ? (
              <>
                ...
                {walk.eatingNote && <p style={{ marginTop: "0.75rem" }}>{walk.eatingNote}</p>}
              </>
            ) : (
              <p>{walk.eatingUrl
